...
export default {
  data() {
    return {
      mapOption: {
          backgroundColor: {↵          type: 'linear',↵          x: 0,↵          y: 0,↵          x2: 1,↵          y2: 1,↵          colorStops: [↵            {↵              offset: 0,↵              color: '#0f378f' ↵            },↵            {↵              offset: 1,↵              color: '#00091a' ↵            }↵          ],↵          globalCoord: false ↵        },↵        title: {↵          top: 20,↵          text: '“会员活跃度” - 山东省',↵          subtext: '',↵          x: 'center',↵          textStyle: {↵            color: '#ccc'↵          }↵        },↵↵        legend: {↵          orient: 'vertical',↵          y: 'bottom',↵          x: 'right',↵          data: ['pm2.5'],↵          textStyle: {↵            color: '#fff'↵          }↵        },↵        visualMap: {↵          show: false,↵          min: 0,↵          max: 500,↵          left: 'left',↵          top: 'bottom',↵          text: ['高', '低'], ↵          calculable: true,↵          seriesIndex: [1],↵          inRange: {}↵        },↵        geo: {↵          map: 'china',↵          show: true,↵          roam: true,↵          label: {↵            normal: {↵              show: false}, emphasis: {show: false }},itemStyle: {normal: {areaColor: '#3a7fd5',borderColor: '#0a53e9', shadowColor: '#092f8f', shadowBlur: 20},emphasis: {areaColor: '#0a2dae' }}},series: [{ symbolSize: 5,label: {normal: {formatter: '{b}',position: 'right', show: true},emphasis: {show: true}},itemStyle: {normal: {color: '#fff'}},name: 'light',type: 'scatter', coordinateSystem: 'geo',data: [{ name: '吉林', value: [121.5135, 25.0308] },{ name: '吉林', value: [127.9688, 45.368] },{ name: '吉林', value: [110.3467, 41.4899] },{ name: '吉林', value: [121.5135, 25.0308] },{ name: '吉林', value: [116.4551, 40.2539] }]},{name: '散点', type: 'scatter',coordinateSystem: 'geo',symbol: 'pin',symbolSize: [50, 50],itemStyle: {normal: {color: '#D8BC37'}},data: [{ name: '吉林', value: [121.5135, 25.0308] },{ name: '吉林', value: [127.9688, 45.368] },{ name: '吉林', value: [110.3467, 41.4899] },{ name: '吉林', value: [121.5135, 25.0308] },{ name: '吉林', value: [116.4551, 40.2539] }],showEffectOn: 'render',rippleEffect: { brushType: 'stroke'}, hoverAnimation: true,zlevel: 1}]
